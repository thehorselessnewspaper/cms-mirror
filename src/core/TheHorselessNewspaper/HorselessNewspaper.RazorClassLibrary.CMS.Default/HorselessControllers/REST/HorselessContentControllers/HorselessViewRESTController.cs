...
{
    [ApiController]
    [Route("{__tenant__}/" + RESTContentModelControllerStrings.API_HORSELESSCONTENTMODEL_HORSELESSVIEW)]
    public class HorselessViewRESTController  : ControllerBase,
        IRESTContentController<HorselessView>
    {

        public IContentCollectionService<IQueryableContentModelOperator<HorselessView>, HorselessView> _contentCollectionService { get; set; }
        public ITenantInfo CurrentTenant { get; set; }

        public HorselessViewRESTController(IContentCollectionService<IQueryableContentModelOperator<HorselessView>,
                HorselessView> contentCollectionService, ITenantInfo tenantInfo)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(HorselessView))]
        [ProducesResponseType(StatusCodes.Status201Created, Type = typeof(HorselessView))]
        public async Task<ActionResult<HorselessView>> Create([FromBody] HorselessView contentCollection)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(HorselessView))]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<HorselessView>> GetByObjectId([FromRoute] string objectId)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(HorselessView))]
        [ProducesResponseType(StatusCodes.Status202Accepted, Type = typeof(HorselessView))]
        public async Task<ActionResult<HorselessView>> Update([FromRoute] string contentCollectionId, [FromBody] HorselessView contentCollection)
        {
        ...
        public async Task<ActionResult<IEnumerable<ContentModel.HorselessView>>> GetByPageNumber(int pageSize = 10, int pageNumber = 1, int pageCount = 1)
        {
