...
namespace HorselessNewspaper.RazorClassLibrary.CMS.Default.HorselessControllers.OData.Hosting
{
    ...
    public class TenantController : ODataController
    {
        ...
        [HttpGet(Name = "GetHostingEntitiesTenant")]
        ...
        public async Task<ActionResult<IQueryable<HostingModel.Tenant>>> GetHostingEntitiesTenant(ODataQueryOptions<TheHorselessNewspaper.Schemas.HostingModel.HostingEntities.Tenant> options)
