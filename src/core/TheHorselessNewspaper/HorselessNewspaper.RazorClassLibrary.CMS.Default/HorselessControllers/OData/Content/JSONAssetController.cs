...
namespace HorselessNewspaper.RazorClassLibrary.CMS.Default.HorselessControllers.OData.Content
{
        ...
        ODataController, IContentController<ContentModel.JSONAsset>
    {
        ...
        public async Task<IActionResult> Create([FromBody] ContentModel.JSONAsset contentCollection)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [HttpPost("Update")]
        [Consumes("application/json")]
        public async Task<IActionResult> Update([FromRoute] string jsonAssetId, [FromBody] ContentModel.JSONAsset contentCollection)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
