...
namespace HorselessNewspaper.Client.Nuget
{
    ...
    /// <summary>
    /// wholly based on https://gist.github.com/bjorkstromm/ad5776c36559410f45d5dcd0181a5c64
    /// </summary>

    public class BjorkStrommNugetLoader : INugetLoader
    {
        LoggerNS.ILogger nugetLogger;
        ILogger<BjorkStrommNugetLoader> ilogger;

        private BjorkStrommNugetLoader()
        {
        }

        public BjorkStrommNugetLoader(LoggerNS.ILogger nugetLoggerAdapter, ILogger<BjorkStrommNugetLoader> logger)
        {
        ...
        public async Task EntryPoint()
        {
            ...
            using (var cacheContext = new SourceCacheContext())
            {
                ...
                await GetPackageDependencies(
                    ...
                    nuGetFramework, cacheContext, ilogger, repositories, availablePackages);
                ...
                ISet<SourcePackageDependencyInfo> availablePackages)
            {
                ...
                foreach (var sourceRepository in repositories)
                {
                    ...
                    var dependencyInfo = await dependencyInfoResource.ResolvePackage(
                        package, framework, cacheContext, nugetLogger, CancellationToken.None);
