...
namespace HorselessNewspaper.Web.Core.Services.Model.Extensions.Claim
{
    public static class HorselessClaimExtensions
    {
        public static string Aud(this IEnumerable<System.Security.Claims.Claim> claims)
        {
        ...
        public static string Iss(this IEnumerable<System.Security.Claims.Claim> claims)
        {
            var ret = string.Empty;
        ...
        public static string Sub(this IEnumerable<System.Security.Claims.Claim> claims)
        {
            var ret = string.Empty;
        ...
        public static string Upn(this IEnumerable<System.Security.Claims.Claim> claims)
        {
            var ret = string.Empty;
        ...
        public static string Email(this IEnumerable<System.Security.Claims.Claim> claims)
        {
            var ret = string.Empty;
        ...
        public static string PreferredUsername(this IEnumerable<System.Security.Claims.Claim> claims)
        {
            var ret = string.Empty;
