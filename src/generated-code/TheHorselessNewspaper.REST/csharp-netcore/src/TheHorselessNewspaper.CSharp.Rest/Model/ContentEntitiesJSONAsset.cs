...
namespace TheHorselessNewspaper.CSharp.Rest.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContentEntitiesJSONAsset")]
    public partial class ContentEntitiesJSONAsset : IEquatable<ContentEntitiesJSONAsset>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentEntitiesJSONAsset" /> class.
        /// </summary>
        ...
        public ContentEntitiesJSONAsset(Guid id = default(Guid), string displayName = default(string), string objectId = default(string), bool? isSoftDeleted = default(bool?), DateTime? createdAt = default(DateTime?), string jsonValue = default(string), string jsonSchema = default(string), List<ContentEntitiesHorselessContent> horselessContents = default(List<ContentEntitiesHorselessContent>), List<ContentEntitiesAccessControlEntry> accessControlList = default(List<ContentEntitiesAccessControlEntry>), List<ContentEntitiesPrincipal> owners = default(List<ContentEntitiesPrincipal>), byte[] timestamp = default(byte[]))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentEntitiesJSONAsset {\n");
        ...
        {
            return this.Equals(input as ContentEntitiesJSONAsset);
        }

        /// <summary>
        /// Returns true if ContentEntitiesJSONAsset instances are equal
        /// </summary>
        /// <param name="input">Instance of ContentEntitiesJSONAsset to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContentEntitiesJSONAsset input)
        {
            if (input == null)
            {
                return false;
