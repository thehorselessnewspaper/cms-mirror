...
{
    /// <summary>
    /// EdmIEdmSchemaElement
    /// </summary>
    [DataContract(Name = "EdmIEdmSchemaElement")]
    public partial class EdmIEdmSchemaElement : IEquatable<EdmIEdmSchemaElement>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EdmIEdmSchemaElement" /> class.
        /// </summary>
        /// <param name="schemaElementKind">schemaElementKind.</param>
        public EdmIEdmSchemaElement(EdmEdmSchemaElementKind? schemaElementKind = default(EdmEdmSchemaElementKind?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdmIEdmSchemaElement {\n");
        ...
        {
            return this.Equals(input as EdmIEdmSchemaElement);
        }

        /// <summary>
        /// Returns true if EdmIEdmSchemaElement instances are equal
        /// </summary>
        /// <param name="input">Instance of EdmIEdmSchemaElement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdmIEdmSchemaElement input)
        {
            if (input == null)
            {
                return false;
