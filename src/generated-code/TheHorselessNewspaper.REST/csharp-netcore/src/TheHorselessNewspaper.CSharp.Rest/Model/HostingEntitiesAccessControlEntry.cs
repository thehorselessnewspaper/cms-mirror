...
namespace TheHorselessNewspaper.CSharp.Rest.Model
{
    ...
    public partial class HostingEntitiesAccessControlEntry : IEquatable<HostingEntitiesAccessControlEntry>, IValidatableObject
    {
        ...
        public HostingEntitiesAccessControlEntry(HostingEntitiesACEPermissionScope? scope = default(HostingEntitiesACEPermissionScope?), HostingEntitiesACEPermission? permission = default(HostingEntitiesACEPermission?), HostingEntitiesACEPermissionType? permissionType = default(HostingEntitiesACEPermissionType?), byte[] timestamp = default(byte[]), List<HostingEntitiesAccessControlEntry> accessControlList = default(List<HostingEntitiesAccessControlEntry>), List<HostingEntitiesPrincipal> owners = default(List<HostingEntitiesPrincipal>), List<HostingEntitiesPrincipal> principals = default(List<HostingEntitiesPrincipal>), Guid id = default(Guid), string displayName = default(string), string objectId = default(string), bool? isSoftDeleted = default(bool?), DateTime? createdAt = default(DateTime?), bool? isActive = default(bool?))
        {
            this.Scope = scope;
