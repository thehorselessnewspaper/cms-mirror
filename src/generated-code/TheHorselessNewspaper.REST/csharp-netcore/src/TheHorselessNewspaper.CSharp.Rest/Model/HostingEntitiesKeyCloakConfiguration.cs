...
namespace TheHorselessNewspaper.CSharp.Rest.Model
{
    ...
    public partial class HostingEntitiesKeyCloakConfiguration : IEquatable<HostingEntitiesKeyCloakConfiguration>, IValidatableObject
    {
        ...
        public HostingEntitiesKeyCloakConfiguration(List<HostingEntitiesAccessControlEntry> accessControlList = default(List<HostingEntitiesAccessControlEntry>), List<HostingEntitiesPrincipal> owners = default(List<HostingEntitiesPrincipal>), bool? isSoftDeleted = default(bool?), byte[] timestamp = default(byte[]), Guid id = default(Guid), string displayName = default(string), string authority = default(string), string realm = default(string), string objectId = default(string), DateTime? createdAt = default(DateTime?), string iss = default(string), string aud = default(string), Guid? tenantInfoId = default(Guid?), HostingEntitiesTenantInfo tenantInfo = default(HostingEntitiesTenantInfo))
        {
