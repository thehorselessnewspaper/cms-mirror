...
namespace TheHorselessNewspaper.CSharp.Rest.Model
{
    ...
    public partial class ContentEntitiesTenant : IEquatable<ContentEntitiesTenant>, IValidatableObject
    {
        ...
        public ContentEntitiesTenant(Guid id = default(Guid), string displayName = default(string), string objectId = default(string), bool? isSoftDeleted = default(bool?), DateTime? createdAt = default(DateTime?), List<ContentEntitiesContentCollection> contentCollections = default(List<ContentEntitiesContentCollection>), bool isPublished = default(bool), ContentEntitiesTenantIdentifierStrategy tenantIdentifierStrategy = default(ContentEntitiesTenantIdentifierStrategy), List<ContentEntitiesAccessControlEntry> accessControlList = default(List<ContentEntitiesAccessControlEntry>), List<ContentEntitiesPrincipal> owners = default(List<ContentEntitiesPrincipal>), List<ContentEntitiesPrincipal> principals = default(List<ContentEntitiesPrincipal>), byte[] timestamp = default(byte[]))
        {
            this.Id = id;
