...
namespace TheHorselessNewspaper.CSharp.Rest.Model
{
    ...
    public partial class ContentEntitiesHorselessSession : IEquatable<ContentEntitiesHorselessSession>, IValidatableObject
    {
        ...
        public ContentEntitiesHorselessSession(Guid id = default(Guid), string displayName = default(string), string objectId = default(string), bool? isSoftDeleted = default(bool?), DateTime? createdAt = default(DateTime?), string sessionId = default(string), string iss = default(string), string aud = default(string), string sub = default(string), bool? isAnonymous = default(bool?), Guid? horselessSessionPrincipalId = default(Guid?), ContentEntitiesPrincipal horselessSessionPrincipal = default(ContentEntitiesPrincipal), List<ContentEntitiesAccessControlEntry> accessControlEntries = default(List<ContentEntitiesAccessControlEntry>), List<ContentEntitiesPrincipal> owners = default(List<ContentEntitiesPrincipal>), byte[] timestamp = default(byte[]), DateTime? updatedAt = default(DateTime?))
        {
            ...
            this.HorselessSessionPrincipalId = horselessSessionPrincipalId;
            this.HorselessSessionPrincipal = horselessSessionPrincipal;
        ...
        /// <summary>
        /// Gets or Sets HorselessSessionPrincipalId
        /// </summary>
        [DataMember(Name = "horselessSessionPrincipalId", EmitDefaultValue = true)]
        public Guid? HorselessSessionPrincipalId { get; set; }

        /// <summary>
        /// Gets or Sets HorselessSessionPrincipal
        /// </summary>
        [DataMember(Name = "horselessSessionPrincipal", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HorselessSessionPrincipalId: ").Append(HorselessSessionPrincipalId).Append("\n");
            sb.Append("  HorselessSessionPrincipal: ").Append(HorselessSessionPrincipal).Append("\n");
        ...
        public bool Equals(ContentEntitiesHorselessSession input)
        {
            ...
            return 
                ...
                (
                    this.HorselessSessionPrincipalId == input.HorselessSessionPrincipalId ||
                    (this.HorselessSessionPrincipalId != null &&
                    this.HorselessSessionPrincipalId.Equals(input.HorselessSessionPrincipalId))
                ) && 
                (
                    this.HorselessSessionPrincipal == input.HorselessSessionPrincipal ||
                    (this.HorselessSessionPrincipal != null &&
                    this.HorselessSessionPrincipal.Equals(input.HorselessSessionPrincipal))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HorselessSessionPrincipalId != null)
                {
                    hashCode = (hashCode * 59) + this.HorselessSessionPrincipalId.GetHashCode();
                }
                if (this.HorselessSessionPrincipal != null)
                {
                    hashCode = (hashCode * 59) + this.HorselessSessionPrincipal.GetHashCode();
                }
