...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ComponentExportRepresentation : IEquatable<ComponentExportRepresentation>, IValidatableObject
    {
        ...
        public ComponentExportRepresentation(MultivaluedHashMap config = default(MultivaluedHashMap), string id = default(string), string name = default(string), string providerId = default(string), MultivaluedHashMap subComponents = default(MultivaluedHashMap), string subType = default(string))
        {
            this.Config = config;
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as ComponentExportRepresentation);
        }
        ...
        public bool Equals(ComponentExportRepresentation input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.SubComponents.Equals(input.SubComponents))
                ) && 
                (
