...
namespace Horseless.Keycloak.Admin.Rest.Model
{
    ...
    internal partial class AccessToken : IEquatable<AccessToken>, IValidatableObject
    {
        ...
        public AccessToken(string acr = default(string), AddressClaimSet address = default(AddressClaimSet), List<string> allowedOrigins = default(List<string>), string atHash = default(string), long authTime = default(long), AccessTokenAuthorization authorization = default(AccessTokenAuthorization), string azp = default(string), string birthdate = default(string), string cHash = default(string), CategoryEnum? category = default(CategoryEnum?), string claimsLocales = default(string), AccessTokenCertConf cnf = default(AccessTokenCertConf), string email = default(string), bool emailVerified = default(bool), long exp = default(long), string familyName = default(string), string gender = default(string), string givenName = default(string), long iat = default(long), string iss = default(string), string jti = default(string), string locale = default(string), string middleName = default(string), string name = default(string), long nbf = default(long), string nickname = default(string), string nonce = default(string), Dictionary<string, Object> otherClaims = default(Dictionary<string, Object>), string phoneNumber = default(string), bool phoneNumberVerified = default(bool), string picture = default(string), string preferredUsername = default(string), string profile = default(string), AccessTokenAccess realmAccess = default(AccessTokenAccess), string sHash = default(string), string scope = default(string), string sessionState = default(string), string sid = default(string), string sub = default(string), List<string> trustedCerts = default(List<string>), string typ = default(string), long updatedAt = default(long), string website = default(string), string zoneinfo = default(string))
        {
            this.Acr = acr;
        ...
        public bool Equals(AccessToken input)
        {
            ...
            return 
                ...
                (
                    this.RealmAccess == input.RealmAccess ||
                    (this.RealmAccess != null &&
                    this.RealmAccess.Equals(input.RealmAccess))
                ) && 
                (
                ...
                (
                    this.TrustedCerts == input.TrustedCerts ||
                    this.TrustedCerts != null &&
                    input.TrustedCerts != null &&
                    this.TrustedCerts.SequenceEqual(input.TrustedCerts)
                ) && 
                (
                    this.Typ == input.Typ ||
                    (this.Typ != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.RealmAccess.GetHashCode();
                }
                if (this.SHash != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.TrustedCerts.GetHashCode();
                }
                if (this.Typ != null)
                {
