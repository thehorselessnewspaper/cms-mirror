        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AccessControlEntry>(entity =>
            {
                ...
                entity.HasMany(d => d.AccessControlEntries)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        r => r.HasOne<AccessControlEntry>().WithMany().HasForeignKey("SubjectAccessControlEntries_Id").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_AccessControlEntryHierarchy_DependentAccessControlEntry"),
                        j =>
                        {
                ...
                entity.HasMany(d => d.SubjectAccessControlEntries)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "AccessControlEntryHierarchy",
                        l => l.HasOne<AccessControlEntry>().WithMany().HasForeignKey("SubjectAccessControlEntries_Id").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_AccessControlEntryHierarchy_DependentAccessControlEntry"),
            ...
            modelBuilder.Entity<Principal>(entity =>
            {
                ...
                entity.HasMany(d => d.OwnedPrincipals)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "PrincipalHierarchy",
                        l => l.HasOne<Principal>().WithMany().HasForeignKey("OwnedPrincipals_Id").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PrincipalHierarchy_OwnerPrincipals"),
                ...
                entity.HasMany(d => d.Owners)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        r => r.HasOne<Principal>().WithMany().HasForeignKey("OwnedPrincipals_Id").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PrincipalHierarchy_OwnerPrincipals"),
                        j =>
                        {
                            j.HasKey("OwnedPrincipals_Id", "Owners_Id");
